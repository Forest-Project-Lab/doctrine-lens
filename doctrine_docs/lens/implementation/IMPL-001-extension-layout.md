...
- 出す内容は入力から一意に定まる。乱数と時刻を使わない（CSP の nonce は表示内容ではないので除く）。
  表示の仕方を変える操作子を持たない（REQ-002）。
- **帰結の画面**は左寄せの行だけで組む。その webview は `<svg>` を一要素も持たない。座標を持たない
  （ADR-012）。System Map(実験)は別画面としてこの限りでない（ADR-030。NONGOAL-001 の範囲も
  0.10.0 で「帰結の画面」に狭めた）。その webview の CSP は script を nonce で縛るが、内蔵 HTML が
  style 属性を使うため style は inline を許す——帰結の webview との差はここに記す。
...
| System Map(実験) | `src/systemMap.ts` | 候補モデルの静的画面を内蔵の HTML で開く。読むだけで、既定の挙動を変えない |
| HTML の内蔵の型 | `src/html.d.ts` | 束ねが text として取り込む `*.html` の型宣言 |
...
この文書が「対象部品」の表で名指す実装のうち、**他のどの仕様にも属さない 10 ファイル**を、
コード側で `doctrine:begin IMPL-001` と `doctrine:end IMPL-001` の対に囲んである
(0.10.0 で `src/systemMap.ts` と `src/html.d.ts` が加わった)。
...
- sha256:1986d868eac8cadfb22039b8908a2dee69ee15ef57dd0a8d513052dd7a7b7689
- sha256:1b1a4a6b95f8d5a8fd664c110964a9fdc90b1b1272b12477349f55d3ed3a93a1
- sha256:3c329c1613a9f39361063de9273b5f664b1f01d62784033e1f2444ae4f63a9e8
- sha256:6943c3efea9b1564ed39964f36ba7313217495d2c513bcdd5a3838653aa16422
- sha256:746fdd92db0b93ea831c24813dc5710f58371289eaa274e0d558cbd23cf39e79
- sha256:78e0c2f1804005ad2f0de684fe82325ad94061b0e2a5018a6000e199e5f69f02
- sha256:7cf27d0b82cae7e7cab9d39c6ecc1dc86dd93296033bee9707deebbd066816e1
- sha256:857a5cc031494a073b71adb7293373935cc38d5960ae14c81ad2c09d935ef205
- sha256:94664fc36b7eafc50b5468589f0f778e2f1b1bd132c443623a9024063b7c35e8
- sha256:9fc5fe287d8967449fa76d992ad8624fd79171d03ac5c6ef13b464c4be863636
